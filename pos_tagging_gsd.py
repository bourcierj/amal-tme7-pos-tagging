...
def train(checkpoint, criterion, train_loader, val_loader, epochs, patience=None, clip=None,
    ...
    def train_epoch():
        ...
        for data, lengths, target in pbar:
            ...
            total_norm = torch.nn.utils.clip_grad_norm_(net.parameters(),
                                                        max_norm=clip)
            if writer:
                writer.add_scalar('Total_norm_of_parameters', total_norm, iteration)
    ...
    def evaluate_epoch():
        ...
        if writer:
            ...
            writer.add_scalar('Val_epoch_accuracy', acc, epoch)
        return val_loss, acc
...
if __name__ == '__main__':
    ...
    # embedding_size = 50
    # hidden_size = 50
    # tensorboard_logdir = './runs/POS-Tagging-v0'
    ...
    writer = SummaryWriter('./runs/POS-Tagging-GRU__'+filename)
